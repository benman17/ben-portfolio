    ...
    <div className="pt-36 pb-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 text-left font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="p-6 bg-[#08080c] border border-[#1a1a20]">
          <div className="text-xs font-bold text-white uppercase tracking-wider mb-2">SQL ETL & DATA WAREHOUSING</div>
        ...
        <div className="p-6 bg-[#08080c] border border-[#1a1a20]">
          <div className="text-xs font-bold text-[#38bdf8] uppercase tracking-wider mb-2">EXECUTIVE BI DASHBOARDING</div>
          <p className="text-xs text-[#8a8a8a] leading-relaxed font-sans font-normal">
        ...
        <div className="p-6 bg-[#08080c] border border-[#1a1a20]">
          <div className="text-xs font-bold text-[#34d399] uppercase tracking-wider mb-2">MACHINE LEARNING & PYSPARK</div>
          <p className="text-xs text-[#8a8a8a] leading-relaxed font-sans font-normal">
      ...
      <div className="space-y-4 pt-4 border-t border-[#1a1a20]">
        <div className="text-xs font-bold text-[#38bdf8] tracking-wider uppercase">MACHINE LEARNING CASE STUDY</div>
        <NflClusterWidget />
      </div>

      {/* Interactive Revenue Sandbox */}
      <div className="space-y-4 pt-4 border-t border-[#1a1a20]">
        <div className="text-xs font-bold text-[#34d399] tracking-wider uppercase">EXECUTIVE REVENUE BI SANDBOX</div>
        <AnalyticsSandbox />
      </div>

      {/* Featured Analytics Projects */}
      <div className="space-y-8 pt-6 border-t border-[#1a1a20]">
        <div className="text-xs font-bold text-white tracking-wider uppercase">ANALYTICS CASE STUDIES</div>
